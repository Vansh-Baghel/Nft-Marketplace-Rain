...
const Card = () => {
  return (
    <div>
      <div className="text-4xl mt-20 text-white text-center font-bold">My NFTS</div>
      <div className="nft-head-out">
        <div className="nft-head"></div>
      </div>
      <div className="flex justify-center align-middle">
        <div className="full-card-box-1 max-w-[20%]">
          <div
            style={{
        ...
        <div className="full-card-box-2 max-w-[20%]">
          <div
            style={{
              fontFamily: "DM Sans, sans-serif",
              fontSize: "1rem",
        ...
        <div className="full-card-box-3 max-w-[20%]">
          <div
            style={{
              fontFamily: "DM Sans, sans-serif",
              fontSize: "1rem",
        ...
        <div className="full-card-box-4 max-w-[20%]">
          <div
            style={{
              fontFamily: "DM Sans, sans-serif",
              fontSize: "1rem",
